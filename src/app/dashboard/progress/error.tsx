    ...
    <div className="max-w-3xl rounded-2xl border border-destructive/20 bg-destructive/10 p-6">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          <h1 className="text-sm font-semibold text-destructive">Progress analytics failed to load</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            {error.message || "Refresh this view to try loading your progress dashboard again."}
          </p>
          <button
            type="button"
            onClick={reset}
